...
public class DataPackageManager {
    ...
    @Autowired
    private DataPackageRequestContext dataPackageRequestContext;

    public ServerResponse processDataPackagePayment(CounterMerchantPaymentRequest counterMerchantPaymentRequest) {
        ServerResponse serverResponse = new ServerResponse();
        try {
            RequestWrapper requestWrapper = encryptData(counterMerchantPaymentRequest);
            serverResponse = dataPackageRequestContext.dataPackagePayment(requestWrapper);
